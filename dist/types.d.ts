export type RoomCapability = 'room:view' | 'message:read' | 'message:send' | 'message:delete' | 'user:mute' | 'room:mute' | 'metrics:read';
export type RoomConnectionState = 'idle' | 'authenticating' | 'bootstrapping' | 'connecting' | 'synchronizing' | 'ready' | 'reconnecting' | 'degraded' | 'ended' | 'closed' | 'error';
